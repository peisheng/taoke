...
//     /*-----------添加鼠标悬停--------------*/
//     var mouseStop=!1;
//     var mouseenter=function(){mouseStop=1;};
//     var mouseleave=function(){mouseStop=!1;};
//     m.addEventListener("mouseenter",mouseenter,!1);
//     m.addEventListener("mouseleave",mouseleave,!1);
//     /*-----------add By zwy--------------*/
...
$(function()
{
    ...
    //添加<li>1</li><li>2</li><li>3</li><li>4</li>
    $('.hd > ul').html('<li class="on">1</li><li>2</li><li>3</li><li>4</li>');

    //添加第一个li到最后
    $('.bd > ul').append('<li>' + $('.bd > ul > li:first').html() + '</li>');
    ...
    // $('.hd > ul > li:first').attr('class','on');

    var arr = new Array(0,-w,-2*w,-3*w,-4*w);
    var i = 1;
    var t = 3000;
    var t1 = 0;
    
    var tt = setInterval(carousel, t - t1);

    //悬停
    // $('.bd > ul').mouseover(function()
    // {
    //     setTimeout(function()
    //     {
    //         clearInterval(tt);
    ...
    $('.hd > ul > li').click(function()
    {
        ...
        $('.hd > ul > li').removeAttr('class');
        $(this).attr('class','on');

        $('.bd > ul').attr('style','width: '+5*w+'px; position: relative; overflow: hidden; padding: 0px; margin: 0px; transition-duration: 600ms; transform: translate('+ arr[i] +'px, 0px) translateZ(0px)');
        clearInterval(tt);
    ...
    { 
        ...
        if(i == 4)
        {
            ...
            setTimeout(function(){
                i = 1;
                $('.bd > ul').attr('style','width: '+5*w+'px; position: relative; overflow: hidden; padding: 0px; margin: 0px; transform: translate(0px, 0px) translateZ(0px)');
            },t1);
        }
        else
        {
